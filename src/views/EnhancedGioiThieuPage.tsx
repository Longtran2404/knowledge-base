          ...
          <div className="overflow-hidden px-4 md:px-8 max-w-6xl mx-auto flex flex-col items-center">
            <LogoLoopMulti
              rows={[
                {
                  logos: [
                    { name: 'Autodesk', icon: <LogoSVGs.Autodesk />, link: 'https://www.autodesk.com' },
                    { name: 'Microsoft', icon: <LogoSVGs.Microsoft />, link: 'https://www.microsoft.com' },
                    { name: 'Google', icon: <LogoSVGs.Google />, link: 'https://www.google.com' },
                    { name: 'AWS', icon: <LogoSVGs.AWS />, link: 'https://aws.amazon.com' },
                    { name: 'Oracle', icon: <LogoSVGs.Oracle />, link: 'https://www.oracle.com' },
                    { name: 'SAP', icon: <LogoSVGs.SAP />, link: 'https://www.sap.com' },
                    { name: 'IBM', icon: <LogoSVGs.IBM />, link: 'https://www.ibm.com' },
                    { name: 'Adobe', icon: <LogoSVGs.Adobe />, link: 'https://www.adobe.com' },
                    { name: 'Siemens', icon: <LogoSVGs.Siemens />, link: 'https://www.siemens.com' },
                    { name: 'Bosch', icon: <LogoSVGs.Bosch />, link: 'https://www.bosch.com' },
                    { name: 'Schneider', icon: <LogoSVGs.Schneider />, link: 'https://www.se.com' },
                  ],
                  speed: 40,
                  direction: 'left',
                },
                {
                  logos: [
                    { name: 'Vingroup', icon: <LogoSVGs.Vingroup />, link: 'https://www.vingroup.net' },
                    ...
                    { name: 'FPT', icon: <LogoSVGs.FPT />, link: 'https://fpt.com.vn' },
