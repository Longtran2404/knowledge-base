...
const ResourceLibrary: React.FC<ResourceLibraryProps> = ({ resources }) => {
  ...
  const filteredResources = resources.filter((resource) => {
    ...
    const matchesField =
      selectedField === "all" || resource.field === selectedField;
    const matchesAccess =
            ...
            >
              ...
              <div className="p-6 border-b border-gray-100">
                <div className="flex items-start justify-between mb-3">
                  {/* File Type Badge */}
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold ${getFileTypeColor(
                      resource.type
                    )}`}
                  >
                  ...
                  {/* Access Level Badge */}
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium border ${getAccessColor(
