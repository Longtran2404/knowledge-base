  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden p-3 rounded-2xl bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white shadow-2xl"
      ...
      <motion.aside
        initial={false}
        animate={{
          x: isOpen || window.innerWidth >= 1024 ? 0 : -400,
        }}
          ...
          <div className="p-6 border-b border-white/10">
            <div className="flex items-center justify-between mb-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="lg:hidden p-2 rounded-xl hover:bg-white/10 text-gray-400 transition-all"
              >
                <X className="h-6 w-6" />
              </motion.button>
            </div>
