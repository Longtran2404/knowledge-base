...
import { SpotlightItem } from '@/lib/mockData';
...
const HeroSpotlight: React.FC<HeroSpotlightProps> = ({ spotlightItem }) => {
  ...
  return (
    <section className={`relative overflow-hidden bg-gradient-to-br ${getGradientByType(spotlightItem.type)} min-h-[600px]`}>
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 rounded-full backdrop-blur-sm mb-6">
              ...
              <span className="text-sm font-semibold">{getTypeLabel(spotlightItem.type)}</span>
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
                ...
                <div className="text-white">
                  ...
                  <p className="text-white/80 text-sm mb-4">Nền tảng giáo dục xây dựng hàng đầu</p>
