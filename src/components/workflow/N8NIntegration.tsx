...
const predefinedWorkflows = [
  ...
  },
  {
    ...
    description:
      "Gửi thông báo và cấp chứng chỉ khi học viên hoàn thành khóa học",
    category: "Education",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description:
      "Tự động xử lý đơn hàng và cấp quyền truy cập sau khi thanh toán",
    category: "E-commerce",
    icon: Zap,
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {workflowStats.totalRuns.toLocaleString()}
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {workflowStats.avgExecutionTime}s
                </p>
              </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                            ...
                            {workflow.lastRun && (
                              <span>Lần cuối: {workflow.lastRun}</span>
                            )}
                          </div>
                        </div>
                      </div>
              ...
              <CardContent className="space-y-4">
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 min-h-[400px] bg-gray-50">
                  <div className="text-center text-gray-500">
                    ...
                    <p>
                      Giao diện visual workflow editor sẽ được tích hợp tại đây
                    </p>
                    <p className="text-sm mt-2">
                      Kết nối với N8N API để chỉnh sửa workflow
                    </p>
                  </div>
                </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Supabase Connection:</strong> Connected • Project: byidgbgvnrfhujprzzge •
          Region: US West 1 • Status: Active
        </AlertDescription>
      </Alert>
    </div>
  );
