...
export function EnhancedFilter({
  ...
  const handleFilterChange = (categoryId: string, optionValue: string, checked: boolean) => {
            ...
            <Card className="border-2 border-blue-100 shadow-lg">
              ...
              <CardContent className="p-6">
                        ...
                        {expandedCategories.includes(category.id) && (
                          ...
                          >
                            {category.options.map((option) => {
                              const isSelected = selectedFilters[category.id]?.includes(option.value) || false;
                ...
                {getActiveFilterCount() > 0 && (
                  ...
                  >
                    <h4 className="font-medium text-gray-700 mb-3">Bộ lọc đang hoạt động:</h4>
