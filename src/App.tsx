...
const SimpleMarketplacePage = React.lazy(() => import("./pages/SimpleMarketplacePage"));
...
const SuccessPremiumPage = React.lazy(() => import("./pages/SuccessPremiumPage"));
const SuccessPartnerPage = React.lazy(() => import("./pages/SuccessPartnerPage"));
const InstructionPage = React.lazy(() => import("./pages/InstructionPage"));
const EnhancedInstructionPage = React.lazy(() => import("./pages/EnhancedInstructionPage"));
                ...
                <div className="App min-h-screen flex flex-col">
                  ...
                  <Routes>
                    ...
                    <Route path="/auth" element={
                      <Suspense fallback={<Loading size="lg" variant="page" text="Đang tải trang đăng nhập..." />}>
                        <AuthPage />
                      </Suspense>
                    } />
                    <Route path="/verify-email" element={
                      <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-pulse">Đang tải...</div></div>}>
                        <VerifyEmailPage />
                      </Suspense>
                    } />
                    <Route
