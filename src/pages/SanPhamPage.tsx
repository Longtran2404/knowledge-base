...
import {
  AnimeScrollEffects,
  StaggerAnimation,
} from "../components/animations/anime-scroll-effects";
          ...
          <AnimeScrollEffects animationType="fadeInUp" delay={200}>
            <section className="text-center py-16 md:py-24 bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl shadow-lg mb-12">
              ...
              <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-8">
                Tối ưu hóa workflow thiết kế với các công cụ thông minh và
                plugin chuyên nghiệp. Tăng hiệu suất làm việc lên 300%.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 p-8">
                <div>
                  ...
                  <p className="text-green-100 text-lg mb-6">
                    Bộ công cụ toàn diện cho automation trong BIM. Tự động hóa
                    quy trình thiết kế, tạo báo cáo và quản lý dự án.
                  </p>
            ...
            <section className="mt-16 text-center">
              <Card className="border-0 shadow-xl bg-gradient-to-r from-emerald-600 to-teal-700 text-white p-8">
                ...
                <p className="text-xl text-emerald-100 mb-6 max-w-2xl mx-auto">
                  Chúng tôi có thể phát triển công cụ tùy chỉnh theo yêu cầu cụ
                  thể của bạn
                </p>
